...
<head>
    ...
    <link href="{{ url('https://www.icajobguarantee.com/assets/css/mobile.css') }}" rel="stylesheet">
    @else
    <link href="{{ url('https://www.icajobguarantee.com/assets/css/style.css') }}" rel="stylesheet">
    @endif
