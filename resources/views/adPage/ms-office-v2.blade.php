        ...
        <div class="container">
            ...
            <div class="text-center">
                ...
                <div class="" >
                    ...
                    <a class="" href="javascript:void(0)"><img src="{{ url('assets/images/gst-logo.png') }}" alt="ICA Edu Skills"></a>
...
<section id="recruiters" class="sponsor-section">
    ...
    <div class="container">
        ...
        <div class="faq-section-title mb35 headline text-center">
            ...
            <h3 class="gradient-title" >Tools You Will Learn</h3>
        ...
        <div class="row">
                ...
                <div class="col-md-3 col-lg-3 col-6 mt10 mb20" >
                    ...
                    <div class="recruiters-grid text-center" >
                        ...
                        <img src="/public/upload/2024-05-24/word.png" alt="Learn Ms Word"><br /><br />
						<span style="color: #000; font-weight: bold;">Document Creation and Formatting</span>
                ...
                <div class="col-md-3 col-lg-3 col-6 mt10 mb20" >
                    ...
                    <div class="recruiters-grid text-center" >
                        ...
                        <img src="/public/upload/2024-05-24/excel.png" alt="Learn MS Excel"><br /><br />
						<span style="color: #000; font-weight: bold;">Spreadsheet Creation and Analysis</span>
                ...
                <div class="col-md-3 col-lg-3 col-6 mt10 mb20" >
                    ...
                    <div class="recruiters-grid text-center" >
                        ...
                        <img src="/public/upload/2024-05-24/powerpoint.png" alt="Learn MS Powerpoint"><br /><br />
						<span style="color: #000; font-weight: bold;">Presentation Design and Delivery</span>
                    </div>
                ...
                <div class="col-md-3 col-lg-3 col-6 mt10 mb20" >
                    ...
                    <div class="recruiters-grid text-center" >
                        ...
                        <img src="/public/upload/2024-05-24/outlook.png" alt="Learn MS Outlook"><br /><br />
						<span style="color: #000; font-weight: bold;">Email Management Communication</span>
...
<section id="recruiters" class="sponsor-section usp-section" style="">
    ...
    <div class="container">
        ...
        <div class="mb35 headline text-center">
            ...
            <h3 class="text-white" >How MS Office Training Classes Work</h3>
            ...
            <div class="col-12 text-center">
                ...
                <div class="section-usp-container" >
                    ...
                    <div class="usp-content"> 
                        ...
                        <h2> Updated MS Office Syllabus </h2>

                        <h6> Amended MS Office modules to keep you on track with the industry. </h6>
                    ...
                    <div class="usp-content"> 
                        ...
                        <h2> Mircosoft Certification </h2>

                        <h6> Get certified as Certified Microsoft Office Professional from Microsoft. </h6>
...
<section id="courses" class="best-course-section">
   ...
   <div class="container">
        ...
        <div class="faq-section-title mb45 headline text-center">
            ...
            <h3 class="gradient-title"> Explore The Best MS Certification Course </h3>
...
<section id="recruiters" class="sponsor-section">
    ...
    <div class="container">
        ...
        <div class="faq-section-title mb45 headline text-center">
            ...
            <p> After getting certified in the MS Office course, several career opportunities await the aspiring candidates to join. To get the right skill set, invest in your future now. Join the Microsoft Certification Program today! </p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <div class="certificate-image-wrapper my-6" >

                    <img src="{{ url('/public/upload/2024-05-24/ms-office-course-certification.webp') }}" >
    ...
    <div class="container">
        ...
        <div class="row" >
            ...
            <div class="col-7 text-right" >
                ...
                <h3 style="color: #fff; font-size: 14px!important; width: 100%; margin: auto;"> Get Certified from Microsoft </h3>
