...
<section id="recruiters" class="sponsor-section usp-section" style="">
    ...
    <div class="container">
        ...
        <div class="mb35 headline text-center">
            ...
            <h3 class="text-white" >How GST Training Classes Work</h3>
            ...
            <div class="col-12 text-center">
                ...
                <div class="section-usp-container" >
                    ...
                    <div class="usp-content"> 
                        ...
                        <h2> Updated GST Syllabus </h2>

                        <h6> Amended GST modules to keep you on track with the industry. </h6>
...
<section id="courses" class="best-course-section">
   ...
   <div class="container">
        ...
        <div class="faq-section-title mb45 headline text-center">
            ...
            <h3 class="gradient-title"> Explore The Best GST Course </h3>
...
<section id="recruiters" class="sponsor-section">
    ...
    <div class="container">
        ...
        <div class="faq-section-title mb45 headline text-center">
            ...
            <p> After getting certified in the GST course, several career opportunities await the aspiring candidates to join. To get the right skill set, invest in your future now. Join the GST Certification Program today! </p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <div class="certificate-image-wrapper my-6" >
                    ...
                    <img src="{{ url('/public/upload/2023-08-23/GST-Certificate.webp') }}" >
    ...
    <div class="container">
        ...
        <div class="row" >
            ...
            <div class="col-7 text-right" >
                ...
                <h3 style="color: #fff; font-size: 15px!important; width: 100%; margin: auto;"> Become A GST Expert </h3>
