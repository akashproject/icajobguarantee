               ...
               <div class="col-md-5 top-right-bar">
                  <div class="header-top-bar ul-li">
                     <ul>
                        ...
                        <li><a href="https://wa.me/9147421932?text=Hello%2C%20I%20would%20like%20to%20know%20more%20about%20the%20stock%20market%20course.%20Please%20guide%20me."><i class='fas fa-comment-alt'></i> Chat With Us</a></li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="navbar-default">
               ...
               <nav class="navbar-menu float-right">
                  <div class="nav-menu ul-li">
                     <ul>
                        <li class="">
                           <a href="#enquiryform">Free Class</a>
                        </li>
						<li class="">
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-7" style="margin-top: 40px!important;">
            <div class="ad-banner-content" style="color: #393185!important; background: #fff!important;">
               ...
               <div class="ad-banner-sub-title" style="padding: 0 15px;">
                  <p class="text-center" style="color:#393185!important;">Learn about financial market, stocks, fundamental analysis, technical analysis, future & option, fixed income, mutual funds and financial planning.</p>
               </div>
               <div class="ad-banner-description" style="overflow-x:auto;">
                  ...
                  <table class="table">
					<tr>
						<td align="center"><strong>Stock Trading Training<br />Option Trading Training</strong></td>
					</tr>						
					<tr>
               ...
               <div class="ad_banner_form_wrapeer" style="background: #fff!important;">
                  ...
                  <div class="row batch-schedule">
                     <div class="col-6 text-center" style="border-right:2px dashed #fff;">
                        ...
                        <h6 style="color: #393185; font-weight: 700; font-size: 14px!important">4<sup>th</sup> Mar, 2025</h6>
                     ...
                     <div class="col-6 text-center" style="border-left:2px dashed #fff;">
                        ...
                        <h6 style="color: #393185; font-weight: 700; font-size: 14px!important">8<sup>th</sup> Mar, 2025</h6>
