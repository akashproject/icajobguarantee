				...
				<div class="container">
					<div class="navbar-default">
						<div class="navbar-header float-left">
							<a class="navbar-brand text-uppercase" href="javascript:void(0)"><img src="{{ url('assets/img/nsc-logo.png') }}" alt="ICA Edu Skills"></a>								
						</div><!-- /.navbar-header -->						
						<div class="navbar-header float-left">
							<a class="navbar-brand text-uppercase" href="javascript:void(0)"><img src="{{ url('assets/img/logo/ICA-NISM-Logo.png') }}" alt="ICA Edu Skills"></a>
						</div><!-- /.navbar-header -->						
