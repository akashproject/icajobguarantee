@extends('layouts.ad-main')
				...
				<div class="container">
					...
					<div class="navbar-default">
						...
						<!--div class="navbar-header float-left">
							...
							<a class="navbar-brand text-uppercase" href="javascript:void(0)"><img src="{{ url('assets/img/logo/ICA-NISM-Logo.png') }}" alt="ICA Edu Skills Logo"></a>
	...
	<section id="enquiryform" class="ad-page-banner relative-position backgroud-style" style="background-image: url({{ (isset($contentMain->banner_image))?getSizedImage('',$contentMain->banner_image):url('assets/img/banner/brt-1.jpg') }});" >
				...
				<div class="col-md-7">
					...
					<div class="ad-banner-content text-white">
						...
						<div class="ad-banner-title">
							...
							<h1 class="text-center">Complete Financial Market Training</h1>

						</div>

						<div class="ad-banner-sub-title">

							<h2 class="text-center">Certified by NSE Academy (Modules include NCCMP Syllabus)</h2>
						...
						<div class="ad_banner_form_wrapeer" style="background: #e9e9e9!important;">
							...
							<div class="row batch-schedule">   
                            	...
                            	<div class="col-6 text-center" style="border-right:2px dashed #fff;">
        							...
        							<h6 style="color: #071e62; font-weight: 700; font-size: 14px!important">17<sup>th</sup> July, 2023</h6>
    							...
    							<div class="col-6 text-center" style="border-left:2px dashed #fff;">
        							...
        							<h6 style="color: #071e62; font-weight: 700; font-size: 14px!important">15<sup>th</sup> July, 2023</h6>
		...
		<div class="container">
			<div class="section-title mb45 headline text-center">
				...
				<header class="section-header" style="padding-bottom: 0!important;">
					<p style="font-size: 18px; font-weight: normal;"> Employer: <img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2023/05/images.png"> </p>
				</header>
			</div>
			...
			<div class="row">
				<div class="col-md-6 text-center">
					...
					<div >
						<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2023/05/1.jpg">
					</div>
				</div>
				<div class="col-md-6 text-center">
					<h5 style="color: #362d86;font-weight: 600;"> Interview Session </h5>
					<div style="width: 56%;margin: 20px auto;">
						<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2023/05/i1.jpg">
					</div>
					<div style="width: 56%;margin: 20px auto;">
						<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2023/05/i3.jpg">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="testimonial-slide">
				...
				<div  id="placement-slide-item" class="placement-slide-area">
					...
					<div class="placement-content">
						...
						<div class="">
							<p class="st-name bold-font">Salary : {{ $value->joining_salary }}</p>
							<p class="st-designation">Dasignation : {{ $value->dasignation }}</p>
						</div>
					</div>
					@endforeach
				</div>
					...
					<div class="student-qoute">
						...
						<div class="course-pic relative-position text-center">
							...
							<div class="circle-img">
								...
								<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/trainer-2.png" alt="Anish Gandhi">	
					...
					<div class="student-qoute">
						...
						<div class="course-pic relative-position text-center">
							...
							<div class="circle-img">
								...
								<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/trainer-1.png" alt="">	
					...
					<div class="student-qoute">
						...
						<div class="course-pic relative-position text-center">
							...
							<div class="circle-img">
								...
								<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/trainer-3.png" alt="Snehasish Bhattacharjee">	
						...
						<div class="photo-list ul-li">
							...
							<ul>
                                ...
                                <li>
									...
									<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/1.jpg" alt="">

									<div class="blakish-overlay"></div>

									<div class="pop-up-icon">

										<a href="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/1.jpg" data-lightbox="roadtrip">
									...
									<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/2.jpg" alt="">

									<div class="blakish-overlay"></div>

									<div class="pop-up-icon">

										<a href="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/2.jpg" data-lightbox="roadtrip">
									...
									<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/3.jpg" alt="">

									<div class="blakish-overlay"></div>

									<div class="pop-up-icon">

										<a href="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/3.jpg" data-lightbox="roadtrip">
                                ...
                                <li>
									...
									<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/5.jpg" alt="">
									...
									<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/6.jpg" alt="">
			  ...
			  <!--@foreach(getRecruiters() as $value)
				...
				@endforeach -->
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Anandrathi.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Angel-One.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Axis-Direct.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Edelweiss.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/ICICI-Securities.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/IIFL.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Indiabulls.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Kotak-Mahindra-Bank.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Motilal-Oswal.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Religare.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/Sharekhan.png" alt="">		
						...
						<div class="placement-grid" >
							...
							<img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2022/12/UTI-Mutual-Fund.png" alt="">		
