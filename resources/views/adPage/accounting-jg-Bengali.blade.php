					...
					<div class="ad-banner-content">
						...
						<div class="ad-banner-option">
						    ...
						    <div>
						        ...
						        <p  class="text-white">Industrial Accounting এর ওপর বিশেষ প্রশিক্ষণ নিয়ে নিজের কেরিয়ার সুনিশ্চিত করুন। </p>
					...
					<div class="highlighted-content-wrapper text-center">
						...
						<div class="ad_banner_form_wrapeer" >
							...
							<div class="register-fomr-title text-center">
								...
								<h3 class="bold-font" style="font-size: 21px!important;"><span> ৬ মাসেই হতে পারেন </span><br /> Certified Industrial Accountant  </h3>

								<p style="color: #222!important;" class="bold-font">আরো জানতে নিচের ফর্মটি ভরুন </p>
						...
						<div class="row text-center">
							...
							<div class="col-md-4 col-6"> 
								...
								<div class="key-highlights" >
									...
									<p> ছাত্র ছাত্রীদের গ্রহণযোগ্যতা বাড়াতে ইন্ডাস্ট্রির চাহিদার সঙ্গে সামঞ্জস্য রেখে Accounting সিলেবাস প্রতিনিয়ত আপডেট করা হয়। </p>
							...
							<div class="col-md-4 col-6"> 
								...
								<div class="key-highlights" >
									...
									<p> ইন্ডাস্ট্রি এক্সপার্ট দ্বারা নির্মিত আমাদের রিয়েল লাইফ প্রজেক্টগুলি ছাত্র ছাত্রীদের হাতেকলমে কাজ শিখিয়ে দক্ষ করে তোলে। </p>
							...
							<div class="col-md-4 col-6"> 
								...
								<div class="key-highlights" >
									...
									<p> ছাত্র ছাত্রীদের ডাউট ক্লিয়ার করার জন্য নিয়মিত ভাবে এক্সপার্ট পরিচালিত বিশেষ ক্লাসের ব্যবস্থা করা হয়। </p>
							...
							<div class="col-md-4 col-6"> 
								...
								<div class="key-highlights" >
									...
									<p> আমাদের Learnersmall App এ বিভিন্ন রকম Quiz ও Assignment এর মাধ্যমে ছাত্র ছাত্রীরা নিজেদের আরও ভালোভাবে প্রস্তুত করতে পারে। </p>
							...
							<div class="col-md-4 col-6"> 
								...
								<div class="key-highlights" >
									...
									<p> প্রতিটি ছাত্র ছাত্রীকে ট্রেনিং শেষের পর বাধ্যতামূলক ফাইনাল পরীক্ষা দিতে হবে। </p>
							...
							<div class="col-md-4 col-6"> 
								...
								<div class="key-highlights" >
									...
									<p> ফাইনাল পরীক্ষার পর প্রতিটি সফল ছাত্র ও ছাত্রীকে ICA Edu Skills ও NSDC এর থেকে সার্টিফিকেট প্রদান করা হবে।  </p>
