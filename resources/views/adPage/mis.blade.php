@extends('layouts.ad-main')
	...
	<style type="">
	    .ad-banner-content { background: inherit!important; }
	</style>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <ul>
                                        ...
                                        <li><strong>No. of Modules:</strong> 6 Modules</li>
				...
				<div class="row">
					...
					<div class="col-md-7 mt10">
						<div class="section-title mb20 headline text-center">
							...
							<h3> MIS Course <span>  Highlights </span></h3>
						</div>
		...
		<div class="container">
			<div class="testimonial-slide">
				<div class="section-title mb20 headline text-center">
					...
					<h3> MIS Analytics <span> Training </span> Syllabus </h3>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="row text-center">
							<div class="col-md-4 col-6"> 
								<div class="key-highlights" >
									<img src="{{ url('assets/img/icons/tick.png')}}" >
									<h6> Module 1 <br /> Power BI </h6>
									<p> Power BI offers data visualization, analysis, integration, real-time monitoring, collaboration, mobile access, and career opportunities </p>
								</div>
							</div>
							<div class="col-md-4 col-6"> 
								<div class="key-highlights" >
									<img src="{{ url('assets/img/icons/tick.png')}}" >
									<h6> Lecture 2 <br /> Advanced Excel </h6>
									<p> Understand advanced Excel for data analysis, automation, complex calculations, reporting, and improved productivity </p>
								</div>
							</div>
							<div class="col-md-4 col-6"> 
								<div class="key-highlights" >
									<img src="{{ url('assets/img/icons/tick.png')}}" >
									<h6> Module 3 <br /> G-Suite </h6>
									<p> Learn handling various apps like Gmail, Google Drive, Google Docs, Google Sheets, Google Slides, Google Calendar, and Google Meet </p>
								</div>
							</div>
							<div class="col-md-4 col-6"> 
								<div class="key-highlights" >
									<img src="{{ url('assets/img/icons/tick.png')}}" >
									<h6> Module 4 <br /> Data Studio </h6>
									<p> Data Studio teaches you to create interactive reports and dashboards using diverse data sources for effective data visualization </p>
								</div>
							</div>
							<div class="col-md-4 col-6"> 
								<div class="key-highlights" >
									<img src="{{ url('assets/img/icons/tick.png')}}" >
									<h6> Module 5 <br /> VBA </h6>
									<p> Learn to automate tasks & save time, analyze data efficiently, enhance report generation, embrace your coding potential </p>
								</div>
							</div>
							<div class="col-md-4 col-6"> 
								<div class="key-highlights" >
									<img src="{{ url('assets/img/icons/tick.png')}}" >
									<h6> Module 6 <br /> SQL </h6>
									<p> Learn data retrieval, query writing, and reporting skills to effectively manage information systems for business decision-making </p>
								</div>
							</div>
						</div>
					</div>
	...
	<section id="courses" class="best-course-section">
		<div class="container">
			<div class="section-title mb45 headline text-center">
				...
				<h3> Browse Our <span> Best MIS </span> Courses </h3>
			</div>
		...
		<div class="container">
			<div class="testimonial-slide">
				<div class="section-title mb20 headline text-center">
					...
					<h3> MIS Analytics <span> Classroom </span> Views </h3>
				</div>
				<div class="row">
					<div class="col-md-12">
		...
		<div class="container">
			<div class="testimonial-slide">
				<div class="section-title mb20 headline text-center">
					...
					<h3> How <span> MIS Training Classes </span> Works? </h3>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="row text-center">
	...
	<section id="certification" class="sponsor-section">
		<div class="container">
			<div class="section-title mb35 headline text-center">
				<span class="subtitle text-uppercase"> COURSE INFO </span>
				<h3> MIS <span> Certification </span> </h3>
			</div>
	       <div class="row">
				...
				<div class="col-md-6 mt10 text-center">
                    <img src="https://wpv1.icajobguarantee.com/wp-content/uploads/2023/08/MIS-Certificate.webp">
				</div>
			</div>
		</div>
	</section>	
