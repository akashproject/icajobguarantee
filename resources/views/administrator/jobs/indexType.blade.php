	...
	@if($jobTypes)
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<h5 class="card-title"> Add New Job Type</h5>
				...
				<div class="card-body">
										...
										<tr>
											<td>{{ $value->name }}
												<div>
													...
													<a href="{{ url('administrator/delete-job-type') }}/{{ $value->id }}" class=""; >Delete </a>
												</div>
											</td>													
											<td>{{ $value->slug }}</td>
											<td>
												<a href="{{ url('administrator/view-job-type') }}/{{ $value->id }}" class="">4</a>
											</td>
										</tr>
										@endforeach							
					...
					<div class="border-top">
						<div class="card-body">
							...
							<input type="hidden" name="job_type_id" id="job_type_id" value="" >
						</div>
					</div>
				</form>
			</div>
