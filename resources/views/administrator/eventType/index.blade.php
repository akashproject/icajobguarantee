...
<div class="col-12">
	@if($eventType)
		<div class="card">
			<div class="card-body">
				<h5 class="card-title"> Add New Event Type</h5>
				<form class="form-horizontal" method="post" action="{{ url('administrator/save-event-type') }}" enctype="multipart/form-data">
				@csrf
				<div class="card-body">
								...
								<table id="zero_config" class="table table-striped table-bordered">
									...
									<tbody>
										...
										<tr>
											<td>{{ $value->name }}
												<div>
													<a href="{{ url('administrator/view-event-type') }}/{{ $value->id }}" class="">Edit</a> | 
													<a href="{{ url('administrator/delete-event-type') }}/{{ $value->id }}" class=""; >Delete </a>
												</div>
											</td>													
											<td>{{ $value->slug }}</td>
											<td>

											<a href="{{ url('administrator/view-event-type') }}/{{ $value->id }}" class="">4</a>
