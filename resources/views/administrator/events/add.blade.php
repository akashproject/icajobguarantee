					...
					<div class="col-md-8" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<input type="text" class="form-control" name="speaker" id="speaker" placeholder="Speaker Name Here" >
						...
						<div class="form-group row">
							...
							<label for="end_date" class="col-sm-3 text-right control-label col-form-label">Start Date</label>

							<div class="col-sm-9">

								<input type="datetime-local" class="form-control" name="end_date" id="end_date" placeholder="Start Date" >
				...
				<div class="row">
					...
					<div class="col-md-8" >
						...
						<div class="form-group row">
							...
							<input type="text" class="form-control" name="robots" id="robots" placeholder="Enter Event Pincode Here" >
