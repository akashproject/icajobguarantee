			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-8" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<input type="text" class="form-control" name="name" id="name" placeholder="Name Here"  value="{{ $event->name }}" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<input type="text" class="form-control" name="slug" id="slug" placeholder="Slug Here"  value="{{ $event->slug }}" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<select name="center_id" id="center_id" class="select2 form-control custom-select" style="width: 100%; height:36px;">	
									...
									<option value="{{  $value->id }}" {{ ( $event->center_id ==  $value->id )? 'selected' : '' }} > {{  $value->name }} </option>
					...
					<div class="form-group row">
						...
						<label for="event_type_id" class="col-md-12 text-left control-label col-form-label">Cateogry</label>

						<div class="col-sm-12">

							<select name="event_type_id" id="event_type_id" class="select2 form-control custom-select" style="width: 100%; height:36px;">	
								<option value="" > Select Event Type </option>
								@foreach ($eventType as $value)

								<option value="{{  $value->id }}" {{ ( $value->id ==  $event->event_type_id )? 'selected' : '' }} > {{  $value->title }} </option>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12">
								...
								<select name="enable_otp" id="enable_otp" class="select2 form-control custom-select" style="width: 100%; height:36px;">	
									...
									<option value="1" {{ ( $event->enable_otp ==  '1' )? 'selected' : '' }}> Yes</option>

									<option value="0" {{ ( $event->enable_otp ==  '0' )? 'selected' : '' }}> No </option>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12">
								...
								<select name="status" id="status" class="select2 form-control custom-select" style="width: 100%; height:36px;">	
									...
									<option value="0" {{ ( $event->status ==  '0' )? 'selected' : '' }}> Private </option>
						...
						<div class="form-group row">
							...
							<div class="col-sm-6 text-center">
								...
								<a href="#imageBox" class="image-profile open-popup-link">
									...
									<img src="{{ (isset($event->featured_image))?getSizedImage('thumb',$event->featured_image):'https://dummyimage.com/150x150?text=Add%20Image' }}" alt="">

									<input type="hidden" name="featured_image" id="featured_image" value="{{ $event->featured_image }}" >	

								</a>	

								@if(isset($event->featured_image))
					...
					<div class="col-md-8" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<input type="text" class="form-control" name="title" id="title" placeholder="Title Here" value="{{ $event->title }}" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<textarea class="form-control" name="meta_description" id="meta_description" placeholder="Enter Meta Description Here" >{{ $event->meta_description }}</textarea>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<textarea class="form-control" name="schema" id="schema" placeholder="Enter Schema Code" >{{ $event->schema }}</textarea>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<input type="text" class="form-control" name="utm_campaign" id="utm_campaign" placeholder="Enter Utm Campaign Here" value="{{ $event->utm_campaign }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<input type="text" class="form-control" name="utm_source" id="utm_source" placeholder="Enter Utm Source Here"  value="{{ $event->utm_source }}">
						...
						<div class="form-group row">
							...
							<input type="text" class="form-control" name="robots" id="robots" placeholder="Enter Center Pincode Here" value="{{ $event->robots }}" >
						...
						<div class="form-group row">
							...
							<input type="text" class="form-control" name="canonical" id="canonical" placeholder="Enter Center Pincode Here" value="{{ $event->canonical }}">
