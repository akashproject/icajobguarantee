...
<div class="col-12">
	<div class="card">
		<form class="form-horizontal" method="post" action="{{ route('admin-save-lam-page') }}" enctype="multipart/form-data">
			@csrf
			<div class="card-body">
				<h4 class="card-title"> Add Lam </h4>
				@if ($errors->any())
				...
				<div class="row">
					...
					<div class="col-md-5">	
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="whatsapp_campaign_id" id="whatsapp_campaign_id" placeholder="Enter Whatsapp Campaign ID" >
							</div>
						</div>
						<div class="form-group row">
				...
				<div class="row">
					<div class="col-md-7" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
							<input type="text" class="form-control" name="robots" id="robots" placeholder="Enter Lam Pincode Here" >
							</div>
						</div>
						<div class="form-group row">
			...
			<div class="border-top">
				...
				<div class="card-body">
					...
					<input type="hidden" name="lam_id" id="lam_id" value="" >
				</div>
