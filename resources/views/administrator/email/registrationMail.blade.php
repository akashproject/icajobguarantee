                                ...
                                <tr>
                                  <td class="pad" style="padding-left:25px;padding-top:10px;width:100%;padding-right:0">
                                    <div class="alignment" align="left" style="line-height:10px">
                                      <img src="https://www.icajobguarantee.com/assets/images/logo.png" style="display:block;height:auto;border:0;width:180px;max-width:100%" width="180" alt="Alternate text" title="Alternate text">
                                    </div>
                                  </td>
                                </tr>
                              </tbody>
                                  ...
                                  <td class="pad" style="padding-bottom:25px;padding-left:25px;padding-right:25px;padding-top:10px">
                                    <div style="font-family:sans-serif">
                                      <div class="" style="font-size:12px;font-family:Montserrat,Trebuchet MS,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Tahoma,sans-serif;mso-line-height-alt:21.6px;color:#393d47;line-height:1.8">
                                        <p style="margin:0;font-size:14px;mso-line-height-alt:25.2px"> Your account has been activated successfully </p>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
