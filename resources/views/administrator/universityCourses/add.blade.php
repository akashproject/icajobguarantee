			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-8" >
						...
						<div class="form-group row">
							<label for="universityCourse_video_title" class="col-sm-3 text-right control-label col-form-label">Video Title</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="universityCourse_video_title" id="universityCourse_video_title" placeholder="Enter Video Title Here" >
							</div>
						</div>
						<div class="form-group row">
							<label for="universityCourse_video_link" class="col-sm-3 text-right control-label col-form-label">Video Link</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="universityCourse_video_link" id="universityCourse_video_link" placeholder="Enter Video Title Here" >
							</div>
						</div>
						<div class="form-group row">
