					...
					<div class="navbar-default">
                        ...
                        <div class="navbar-header float-right" style="width: auto;text-align: right;">
							<a class="navbar-brand text-uppercase" href="javascript:void(0)"  style="text-align: center;"> 
                                <img src="{{ url('assets/img/gcr-logo.png') }}" alt="ICA Edu Skills" style="width: 35%;">
                            </a>
						</div><!-- /.navbar-header -->	
					</div>
				</div>
                    ...
                    <div class="col-md-8 py-2">
                        <div class="banner_container">
                            <div class="banner_header">
                                <h1 style="color: #e53d3f;text-align: center;">Ranchi’s Biggest Job Fair*</h1>
                            ...
                            <div class="banner_content">
                                <div class="text-center">
                                    <h5 style="color:#ff0000"> <strong></strong> </h5>
                                </div>
                            </div>
                                        ...
                                        <div class="form_process" >
                                            <div class="lead_steps step1 active"> 
                                                ...
                                                <div class="field_step_2" style="display:none">
                                                    ...
                                                    <div class="register-form-area">
                                                        <select class="session" name="session" required>
                                                            <option value=""> Select Session </option>
                                                            <option value="Under Graduate - 2025-2029">Under Graduate - 2025-2029</option>
                                                            <option value="Under Graduate - 2024-2028">Under Graduate - 2024-2028</option>
                                                            <option value="Under Graduate - 2023-2027">Under Graduate - 2023-2027</option>
                                                            <option value="Under Graduate - 2022-2026">Under Graduate - 2022-2026</option>
                                                            <option value="Post Graduate - 2024-2026">Post Graduate - 2024-2026</option>
                                                            <option value="Post Graduate - 2023-2025">Post Graduate - 2023-2025</option>
                                                            <option value="Post Graduate - 2022-2024">Post Graduate - 2022-2024</option>
                                                        </select>
                                                    </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="organizar py-3">
                        <h1 style="font-size: 37px;"> Gossner College & ICA Ranchi, Job Fair 2025</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="slot py-5">
                        ...
                        <h4>Arts, Science, Commerce and Vacation UG / PG</h4>
                    </div>
                </div>
            </div>
            <hr class="dashed">
                ...
                <div class="col-12">
                    <div class="agenda mb-5 mt-3">
                        ...
                        <div class="agenda-content message_container p-5" style="width: 100%;">
                            <h3> *Held under Gossner College, for college students, graduate and working professional. </h3>
                        </div>
                    </div>
                </div>
            </div>
