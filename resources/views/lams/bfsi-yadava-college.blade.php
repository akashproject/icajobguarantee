            ...
            <div class="container">
				<div class="row d-flex align-items-center justify-content-between">
					<div class="col-xl-7 col-md-12 my-4 ps-lg-5">
						...
						<div class="d-flex">
							<a href="javascript:void(0);" class="banner-logo"><img src="/assets/frontend/bfsi/images/bfsi.png" alt="" class="img-fluid"></a>
							<a href="{{ url('/') }}" class="banner-logo-ica mb-4 ml-2"><img src="/assets/frontend/bfsi/images/logo-ica.png" alt="" class="img-fluid"></a>
							<a href="https://www.yadavacollege.ac.in/" class="banner-logo mb-4 ml-2"><img src="/assets/img/yadavacollege.png" alt="" class="img-fluid"></a>
						</div>
						@endif
						@if(check_device("mobile"))
						<div class="d-flex">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				<h2 class="number-headline mb-5">Yadava College & ICA Madurai, Seminar 2025</h2>
			</div>
		</div>
		<div class="row">
...
<script>
	$(document).ready(function () {
		...
		const startDate = new Date('2025-09-03T10:00:00'); // Example: Jan 1, 2025
