...
<body>
            ...
            <div class="container">
				<div class="row d-flex align-items-center justify-content-between">
					<div class="col-xl-7 col-md-12 my-4 ps-lg-5">
						...
						<h2>Join the Finance Session Everyone's Talking About!</h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="number-headline mb-5">Gossner College & ICA Ranchi, Job Fair 2025</h2>
				</div>
			</div>
			<div class="row">
	...
	<section class="section-experience">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h2 class="experience-headline mb-5">Register to:</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<div class="experience-bar mb-4">
						<h4>Get Ready for a Life-Changing Experience!</h4>
						<ul>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Connect with top companies,</li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Explore career opportunities,</li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Kick-start your success journey,</li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Know your employability score</li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">you are a B.Com/BBA/BCA student Upgrade your skills </li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">find alternate career paths</li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Meet with industry leaders and changemakers</li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Get updates from the corporate world</li>
						</ul>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="experience-bar mb-4">
						...
						<ul>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Job Opportunities in Accounts, Taxation, Finance, Banking, MIS, Sales, and more! </li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Networking Opportunities with top companies and industry experts </li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Free Employability Assessment &amp; Orientation Workshop <strong>(worth 10000/-)</strong> </li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Complimentary expert-led workshop </li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Worth Rs: 30,000 for first 1000 registrations </li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Focussed Tech Workshops in Accounts, Banking, MIS, Taxation, Finance worth Rs.10000. </li>
							<li><img src="/assets/frontend/bfsi/images/check.svg" alt="">Registration on ICA Job Portal <strong>Rs.10000.</strong> </li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-xl-7 text-center">
					<h2 class="experience-headline mb-5">Lorem ipsum dolor sit amet consectetur</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4">
	...
	<script>
        $(document).ready(function () {
			...
			const startDate = new Date('2025-08-05T00:00:00'); // Example: Jan 1, 2025
