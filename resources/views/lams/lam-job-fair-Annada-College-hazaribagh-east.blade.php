...
<body>
                    ...
                    <div class="col-md-8 py-2">
                        <div class="banner_container">
                            <div class="banner_header">
                                <h1 style="color: #e53d3f;text-align: center;">Hazaribagh’s Biggest Job Fair*</h1>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="organizar py-3">
                        <h1 style="font-size: 37px;"> ICA Hazaribagh & Annada College, Job Fair 2025</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-12">
                    <div class="agenda mb-5 mt-3">
                        ...
                        <div class="agenda-content message_container p-5" style="width: 100%;">
                            <h3> *Held under Annada College. </h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        let eventDate = new Date("2025-08-26T11:59:59").getTime();
    </script>
