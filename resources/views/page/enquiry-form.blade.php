                        ...
                        <div class="popup_banner_form_wrapeer" > 
                            <div class="row"> 
                                <div class="col-md-5" >
                                    <div class="row"> 
                                        <div class="col-12" >
                                            <div class="wizerd_header active"><span>1.</span><h4>Personal Details</h4></div>
                                        </div>
                                        <div class="col-12" >
                                            <div class="wizerd_header"><span>2.</span><h4>Qualification</h4> </div>
                                        </div>
                                        <div class="col-12" >
                                            <div class="wizerd_header"><span>3.</span><h4>Work Experience</h4></div>
                                        </div>
                                        <div class="col-12" >
                                            <div class="wizerd_header"><span>4.</span><h4>ICA Details</h4></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7" >
                                    <form id="global_other_details_form" class="contact_form lead_form" action="{{ url('enquiry-form-submit') }}" method="POST" enctype="multipart/form-data">
                                        <div class="form_process" >
                                            <div id="personal_details" class="form_section active">
                                                <h3>Tell Me something about yourself</h3>
                                                <div class="row" > 
                                                    @csrf
                                                    <div class="col-12" >
                                                        <div class="contact-info formFieldName">
                                                            <input id="formFieldName" name="name" type="text" placeholder="May I know your full name?" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-12" >
                                                        <div class="contact-info formFieldEmail">
                                                            <input id="formFieldEmail" name="email" type="email" placeholder="Share Your Email ID" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-12" >
                                            ...
                                            <div id="qualification" class="form_section">
