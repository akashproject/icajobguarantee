...
<body>
					...
					<div class="navbar-default">
						...
						<div class="navbar-header float-right" style="width: auto;text-align: right;">
							<a class="navbar-brand text-uppercase" href="javascript:void(0)"  style="text-align: center;"> 
                                <img src="{{ url('assets/img/gccba-logo-chandigarh.png') }}" alt="ICA Edu Skills" style="width: 35%;">
                            </a>
						</div><!-- /.navbar-header -->		
					</div>
				</div>
                    ...
                    <div class="col-md-8 py-2">
                        <div class="banner_container">
                            <div class="banner_header">
                                <h1 style="color: #e53d3f;text-align: center;">Chandigarh’s Biggest Job Fair*</h1>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="organizar py-3">
                        <h1 style="font-size: 37px;"> ICA Chandigarh & Government College Of Commerce & Business Administration , Job Fair 2025</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-12">
                    <div class="agenda mb-5 mt-3">
                        ...
                        <div class="agenda-content message_container p-5" style="width: 100%;">
                            <h3> *Held under Government College Of Commerce & Business Administration, for college students, graduate and working professional. </h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        let eventDate = new Date("2025-03-27T09:59:59").getTime();
    </script>
