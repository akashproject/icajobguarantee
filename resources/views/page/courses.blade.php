												...
												<div class="course-list-img-text">
													...
													<div class="course-list-text">
														...
														<div class="course-meta">
															...
															<span class="course-category bold-font"><a href="#">{{ thousandsCurrencyFormat($value->number_of_rating) }} Rating </a></span>
														</div>
													</div>
												</div>
											</td>
										...
										<div class="col-md-4">
											<div class="best-course-pic-text relative-position">
												...
												<div class="more-btn text-center" >
													<div class="course-type-list">	
														<a class="btn-filled" href="javascript:void(0)" onclick="lead_capture_form_btn({{ $course->id }},'')"><i class="fas fa-download"></i> Brochure</a>
													</div>
													<div class="course-type-list">		
						...
						<div class="best-course-pic-text relative-position">
							...
							<div class="best-course-text">
								<div class="course-type-title mb10 headline relative-position">
									<h3><a target="_blank" href="{{ URL::to('/category') }}/{{ $value->slug }}">{{ $value->name }}</a></h3>
								</div>
