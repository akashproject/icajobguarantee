										...
										<div id="tab1" class="tab-content-1 best-product-section">
											<div class="row">
												<div class="col-12 mb-3">
													<h4 style="font-size: 19px;color: #333;"> {{count(getCenters()) }} Centers found</h4>
												</div>
											</div>
											<div class="row">
													...
													<div class="product-img-text">
														...
														<div class="course-meta mb10 text-center">
															<span class="course-category">
																...
																<a href="{{ url('/city/'.getCityById($value->city_id)->slug) }}"> {{ (getCityById($value->city_id) !== null)?getCityById($value->city_id)->name:'' }} </a>
															</span>
														</div>
