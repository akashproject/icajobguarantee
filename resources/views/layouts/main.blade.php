...
<head>
    ...
    <title>{{ $contentMain->title }}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="title" content="{{ $contentMain->title }}">
    <meta name="description" content="{{ $contentMain->meta_description }}">
    ...
    <meta property="og:title" content="{{ $contentMain->title }}" />
    <meta property="og:description" content="{{ $contentMain->meta_description }}" />
    ...
    <meta name="twitter:title" content="{{ $contentMain->title }}" />
    <meta name="twitter:description" content="{{ $contentMain->meta_description }}" />
