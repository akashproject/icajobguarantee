		...
		<section id="genius-teacher-2" class="genius-teacher-section-2 one-page-teacher backgroud-style">
			<div class="container">
				...
				<div class="teacher-third-slide">
					...
					<div class="teacher-double">
						<div class="teacher-img-content relative-position">
							<img src="assets/img/teacher/ts-2.jpg" alt="">
							<div class="teacher-cntent">
								<div class="teacher-social-name ul-li-block">
									<ul>
										<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
						...
						<div class="teacher-img-content relative-position">
							<img src="assets/img/teacher/ts-3.jpg" alt="">
							<div class="teacher-cntent">
								<div class="teacher-social-name ul-li-block">
									<ul>
										<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
					...
					<div class="teacher-double">
						<div class="teacher-img-content relative-position">
							<img src="assets/img/teacher/ts-4.jpg" alt="">
							<div class="teacher-cntent">
								<div class="teacher-social-name ul-li-block">
									<ul>
										<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
						...
						<div class="teacher-img-content relative-position">
							<img src="assets/img/teacher/ts-5.jpg" alt="">
							<div class="teacher-cntent">
								<div class="teacher-social-name ul-li-block">
									<ul>
										<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
					...
					<div class="teacher-double">
						<div class="teacher-img-content relative-position">
							<img src="assets/img/teacher/ts-6.jpg" alt="">
							<div class="teacher-cntent">
								<div class="teacher-social-name ul-li-block">
									<ul>
										<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
